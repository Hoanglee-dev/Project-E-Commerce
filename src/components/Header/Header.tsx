...
export default function Header() {
  ...
  const logoutMutaton = useMutation({
    ...
    onSuccess: () => {
      queryClient.removeQueries({ queryKey: ['purchases', { status: purchasesStatus.productInCart }] })
                      ...
                      <>
                        ...
                        <div className='mt-5'>
                          {purchasesInCart.slice(0, 5).map((purchase) => (
                            <div className='p-1 flex hover:bg-gray-100' key={purchase.product._id}>
                        ...
                        <div className='mt-6 items-center flex justify-between'>
                          ...
                          <Link
                            to={path.cart}
                            className='cursor-pointer capitalize bg-orange hover:bg-opacity-80 px-4 py-2 rounded-sm text-white '
                          >
                            Xem giỏ hàng
                          </Link>
                        </div>
